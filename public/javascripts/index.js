...
const buttonRipple = new mdc.ripple.MDCRipple(document.querySelector('#forget'));
/* EVENTS */
...
$("#form").submit(event => {
    ...
    $.get(`${baseUrl}getbalance?address=${address}`, resp => { // to avoid cors we're getting the balance server-side
